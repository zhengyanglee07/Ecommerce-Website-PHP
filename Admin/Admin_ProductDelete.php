                        ...
                        <form action="" method="post">
                            <table style="display: block; margin: 20px auto 20px auto; border: solid black 1px; padding: 2%; font-size: 1.2em; font-family: cursive; margin-top: 35px;" border="0" cellpadding="10" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $pID?></td>
                                    <td><input type="hidden" name="ProductCode" value="<?php echo $pID?>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="ProductName" value="<?php echo $pName?>"></td>
                                </tr>
                                <tr>
                            ...
                            <a href="Admin_ProductList.php"><button type="button" name="back" class="btn btn-secondary" style="width: 200px; font-weight: 500; float: left; margin-bottom: 5em;">Back To List</button></a>
                            <button type="submit" name="delete" class="btn btn-danger" style="width: 200px; font-weight: 500; float: right; margin-bottom: 5em;">Delete</button>
                        </form>
                        <?php endif;?>
                    </div>
                </main>
