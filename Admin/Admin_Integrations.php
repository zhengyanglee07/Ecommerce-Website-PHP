...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-5" href="#" style="font-size: 20px; font-weight: 500;">Noble Phoenix Admin</a>
            <button class="navbar-toggler position-absolute d-md-none collapsed" type="button">
                <span class="navbar-toggler-icon"></span>
            </button>
            
            <div style=" margin-left: 65%;">
                <a class="nav-link" href="#"><span data-feather="bell" style=" width: 25; height: 25;"></span></a>
            </div>
            
            <div class="nav-item text-nowrap" style=" margin-left: 15px;">
                <a class="nav-link" href="#">View My Shop</a>
            </div>
            ...
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="sidebar-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="Admin_Integrations.php">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h1"><i data-feather="layers" style=" width: 45px; height: 45px; margin-left: 10px; margin-right: 20px; margin-top: 20px;"></i>Integrations</h1>
                    ...
                    <div class="container" style=" margin-top: 50px;">
                        <div class="card-deck">
                            <div class="card">
                                <img src="image/example.png" class="rounded mx-auto d-block" alt="...">
                                <div class="card-body">
